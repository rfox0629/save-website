...
export default async function VoiceAlignmentPublicPage({
      ...
      <main className="min-h-screen bg-[#F9F6F0] px-6 py-10">
        <div className="mx-auto max-w-3xl space-y-8">
          <section className="rounded-[32px] border border-[#B8D2EE] bg-[#E8F0FA] px-8 py-10">
            ...
            <p className="mt-4 text-base leading-8 text-[#3D5576]">
  ...
  return (
    <main className="min-h-screen bg-[#F9F6F0] px-6 py-10">
      <div className="mx-auto max-w-3xl space-y-8">
        <section className="rounded-[32px] border border-[#D8D1C3] bg-[linear-gradient(135deg,#FFFDF8_0%,#F4EFE4_100%)] p-8 shadow-[0_25px_80px_rgba(26,68,128,0.08)]">
          <p className="text-sm font-semibold uppercase tracking-[0.35em] text-[#7088A5]">
            Voice Alignment
          </p>
          <h1
