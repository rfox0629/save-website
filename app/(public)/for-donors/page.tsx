    ...
    <main className="bg-[#F9F6F0] pt-[68px] text-[#1A2E20]">
      <section className="bg-[#FEFCF8] px-6 py-20 md:px-[52px] md:py-24">
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="font-public-serif mt-6 max-w-[700px] text-[38px] font-medium leading-[1.08] text-[#1B4D35] md:text-[62px]">
          ...
          <div className="rounded-[30px] border border-[rgba(27,77,53,0.1)] bg-white p-8 shadow-[0_16px_45px_rgba(27,77,53,0.08)] md:p-10">
            <div className="border-b border-[rgba(27,77,53,0.08)] pb-5">
            ...
            <div className="space-y-4 py-6">
              {inclusions.map((item) => (
                <div className="flex gap-4" key={item}>
                  ...
                  <p className="text-[15px] leading-[1.75] text-[#3D5C47]">
                    {item}
                  </p>
                </div>
              ))}
            </div>
            <div className="rounded-[22px] bg-[#1B4D35] px-6 py-6 text-white">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              ...
              <div
                ...
                key={title}
              >
                <h3 className="font-public-serif text-[24px] text-[#1B4D35]">
                  {title}
                </h3>
      ...
      <section className="py-18 bg-[#F0EBE0] px-6 md:px-[52px] md:py-24">
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-2">
            ...
            <ul className="mt-6 space-y-4">
              {inclusions.map((item) => (
                <li className="flex gap-4" key={item}>
                  ...
                  <p className="text-[15px] leading-[1.8] text-[#3D5C47]">
                    {item}
                  </p>
                </li>
              ))}
          ...
          <div className="rounded-[28px] border border-[rgba(27,77,53,0.1)] bg-[#1B4D35] p-8 text-white shadow-[0_14px_40px_rgba(27,77,53,0.12)]">
