  ...
  const renderDocumentField = (field: VettingDocumentType) => {
    ...
    return (
      <div className="space-y-2" key={field}>
        <label className="text-sm font-medium text-[#1A4480]">
        ...
        />
        {uploading[field] ? (
          <p className="text-xs text-[#7088A5]">Uploading...</p>
        ) : null}
        {pending ? (
          <p className="text-xs text-[#7088A5]">Selected: {pending.name}</p>
        ) : null}
        {existing ? (
              ...
              {(readOnly || currentStep === 0) && (
                <div className="grid gap-5 md:grid-cols-2">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    />
                    <div className="flex justify-between text-xs text-[#7088A5]">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    {REFERENCE_ROWS.map((index) => (
                      <div
                        ...
                        key={index}
                      >
                        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#7088A5]">
                          Reference {index}
                        </p>
                        <TextInput
                          readOnly={readOnly}
